    ...
    private static CookingInstructor.RecipeNS.Recipe[] list = new CookingInstructor.RecipeNS.Recipe[]{
        new CookingInstructor.RecipeNS.Recipe{
            ...
            Steps = new String[]
                    {"1. Put the pork inside a container and fill with cold water that covers it, wait for 1.5 ~ 2 hours",
                        ...
                        "4. Cut part of Green Onions into small pieces(Don't cut them all), as well as red pepper.",
                        ...
                        "10. Add knoted Beancurd Sheets, red pepper, Green Onion(not chopped). Then cover the pot and wait for sometime(depends on the water left in pot), remember to check the water level, we don't want to charred it. ",
        ...
        new CookingInstructor.RecipeNS.Recipe{ 
            ...
            Steps = new String[]
                    {"1. Cut Tofu into small cubes and slice Ginger, then add 1.5L water into your pot, add Tofu, Cooking wine, sliced Ginger, wait for boiling.",
                        ...
                        "3. Cut Red Pepper,Garlic, Green Onion into pieces",
                        "4. Put all the Sauces in one container, more convenience for later useage.",
                        "5. Add 5g Green Onion, Red Pepper, Garlic, Oil and frying them for around 30 seconds.",
        ...
        new CookingInstructor.RecipeNS.Recipe{
            ...
            Steps = new String[]{
                ...
                "2. Add Salt, Powdered pepper, Cooking Wine, Seasoning soy sauce and Starch into container, mix them well with hand or some tool.",
        ...
        new CookingInstructor.RecipeNS.Recipe{
            ...
            Steps= new String[]{ 
                ...
                "2. Prepare sauce. Grab a container, add Seasoning soy sauce, Dark soy sauce, Cooking wine, Oyster sauce, Sugar, Starch, Salt, Water, Powdered Pepper and mix them well.",
